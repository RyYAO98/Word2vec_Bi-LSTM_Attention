...
print(u"请选择大语料的分词文本...")
T = TextSta(askopenfilename(title=u"选择文件"))
...
#model_name = input(u"请输入保存的模型文件名...\n")
# model.save(model_name + u'.model')  # 保存模型
model.wv.save_word2vec_format("D:\\my_work\\word2Vec" + ".bin", binary=True)
